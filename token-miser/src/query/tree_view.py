...
def build_tree_view(
    ...
    lines.append(bold("Token Miser — Unit Tree"))
    ...
    # ── Summary footer ────────────────────────────────────────────────────────
    lines.append(grey("  Use 'miser expand <ids>' to see full code for any unit."))
    lines.append(grey("  Use 'miser fix \"<task>\"' to auto-select and fix."))
